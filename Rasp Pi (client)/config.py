...
POSITIVE_DIR1 = './training1/positive'
NEGATIVE_DIR1 = './training1/negative'
...
#Max failed passcode attempts 
PASSCODE_UPLIMIT = 3
# Time to enter passcode again after reaching max failed passcode attempts
break_time = 30
#PASSCODE = open(PASSCODE_FILE,'r').read().splitlines()
